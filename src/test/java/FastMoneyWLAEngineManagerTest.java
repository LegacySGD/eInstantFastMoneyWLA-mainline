...
public class FastMoneyWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(FastMoneyWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/FastMoneyWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/FastMoneyWLAIW/InitOutcome.xml").getDocumentElement();
